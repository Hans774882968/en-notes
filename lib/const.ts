export const MERGED_MD_NAME = 'en_notes.md';
export const SEPARATE_FILES_ZIP_FOLDER = 'en_notes';
export const SEPARATE_FILES_ZIP_NAME = 'en_notes.zip';
export const WORDS_MD = 'words.md';
export const CN_WORDS_MD = 'cnWords.md';
